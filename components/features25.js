    ...
    <>
            ...
            >
              ...
              <div className="features25-thq-content-elm3">
                <h2 className="thq-heading-2">
                  {props.feature3Title ?? (
                    <Fragment>
                      <span className="features25-text5">Feature #3</span>
                    </Fragment>
                  )}
                </h2>
                <span className="thq-body-small">
      ...
      <style jsx>
        {`
          ...
          .features25-thq-tab-horizontal-elm1 {
            gap: 32px;
            cursor: pointer;
            display: flex;
            overflow: hidden;
          ...
          .features25-thq-divider-container-elm1 {
            display: flex;
            align-self: stretch;
            align-items: flex-start;
          }
          ...
          .features25-thq-tab-horizontal-elm2 {
            gap: 32px;
            cursor: pointer;
            display: flex;
            overflow: hidden;
          ...
          .features25-thq-divider-container-elm2 {
            display: flex;
            align-self: stretch;
            align-items: flex-start;
          }
          ...
          .features25-thq-tab-horizontal-elm3 {
            gap: 32px;
            cursor: pointer;
            display: flex;
            overflow: hidden;
          ...
          .features25-thq-divider-container-elm3 {
            display: flex;
            align-self: stretch;
            align-items: flex-start;
          }
          ...
          .features25-thq-image-container-elm {
            height: 100%;
            display: flex;
            position: relative;
          }
