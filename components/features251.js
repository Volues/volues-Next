    ...
    <>
      <div className="thq-section-padding">
        <div className="features251-container2 thq-section-max-width">
          <div className="features251-thq-tabs-menu-elm">
            <div
              onClick={() => setActiveTab(0)}
              className="features251-thq-tab-horizontal-elm1"
            >
              <div className="features251-thq-divider-container-elm1">
                {activeTab === 0 && (
                  <div className="features251-container3"></div>
                )}
              </div>
              <div className="features251-thq-content-elm1">
                <h2 className="thq-heading-2">
                  {props.feature1Title ?? (
                    <Fragment>
                      <span className="features251-text3">Feature #1</span>
                    </Fragment>
                  )}
                </h2>
            ...
            <div
              ...
              className="features251-thq-tab-horizontal-elm2"
            >
              <div className="features251-thq-divider-container-elm2">
                {activeTab === 1 && (
                  <div className="features251-container4"></div>
                )}
              </div>
              <div className="features251-thq-content-elm2">
                <h2 className="thq-heading-2">
                  {props.feature2Title ?? (
                    <Fragment>
                      <span className="features251-text6">Feature #2</span>
                    </Fragment>
                  )}
                </h2>
                <span className="thq-body-small">
            ...
            <div
              ...
              className="features251-thq-tab-horizontal-elm3"
            >
              <div className="features251-thq-divider-container-elm3">
                {activeTab === 2 && (
                  <div className="features251-container5"></div>
                )}
              </div>
              <div className="features251-thq-content-elm3">
                <h2 className="thq-heading-2">
                  {props.feature3Title ?? (
                    <Fragment>
                      <span className="features251-text4">Feature #3</span>
                    </Fragment>
                  )}
                </h2>
                <span className="thq-body-small">
          ...
          <div className="features251-thq-image-container-elm">
            {activeTab === 0 && (
              <img
      ...
      <style jsx>
        {`
          ...
          .features251-thq-tab-horizontal-elm1 {
            gap: 32px;
            cursor: pointer;
            display: flex;
            overflow: hidden;
          ...
          .features251-thq-divider-container-elm1 {
            display: flex;
            align-self: stretch;
            align-items: flex-start;
          }
          ...
          .features251-thq-tab-horizontal-elm2 {
            gap: 32px;
            cursor: pointer;
            display: flex;
            overflow: hidden;
          ...
          .features251-thq-divider-container-elm2 {
            display: flex;
            align-self: stretch;
            align-items: flex-start;
          }
          ...
          .features251-thq-tab-horizontal-elm3 {
            gap: 32px;
            cursor: pointer;
            display: flex;
            overflow: hidden;
          ...
          .features251-thq-divider-container-elm3 {
            display: flex;
            align-self: stretch;
            align-items: flex-start;
          }
          ...
          .features251-thq-image-container-elm {
            height: 100%;
            display: flex;
            position: relative;
          }
