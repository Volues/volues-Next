...
const Header = (props) => {
  return (
    <>
      <div
        data-role="Header"
        className={`header-thq-thq-header-elm-elm ${props.rootClassName} `}
      >
        <div className="header-container1">
          <img
            alt={props.imageAlt}
            src={props.imageSrc}
            className="header-thq-image-elm"
          />
        </div>
        <div
          data-role="BurgerMenu"
          className="header-thq-thq-burger-menu-elm-elm"
        >
          <svg
            width="40"
            height="40"
        ...
        <div
          ...
          className="header-thq-thq-mobile-menu-elm-elm"
        >
          <div className="header-thq-thq-top-elm-elm">
            <h1 className="header-thq-thq-heading-elm-elm TextSM">
              {props.heading11}
            </h1>
            <div
              data-role="CloseMobileMenu"
              className="header-thq-thq-close-menu-elm-elm"
            >
          ...
          <div className="header-thq-thq-mid-elm-elm">
            ...
            <div className="header-container4">
              ...
              <span className="header-text2 TextSM">BLOG</span>
            </div>
          </div>
          <div className="header-thq-thq-bot-elm-elm">
            <svg viewBox="0 0 877.7142857142857 1024" className="header-icon30">
              <path d="M713.143 73.143c90.857 0 164.571 73.714 164.571 164.571v548.571c0 90.857-73.714 164.571-164.571 164.571h-107.429v-340h113.714l17.143-132.571h-130.857v-84.571c0-38.286 10.286-64 65.714-64l69.714-0.571v-118.286c-12-1.714-53.714-5.143-101.714-5.143-101.143 0-170.857 61.714-170.857 174.857v97.714h-114.286v132.571h114.286v340h-304c-90.857 0-164.571-73.714-164.571-164.571v-548.571c0-90.857 73.714-164.571 164.571-164.571h548.571z"></path>
            </svg>
            <svg viewBox="0 0 1024 1024" className="header-icon32">
              <path d="M1024 226.4c-37.6 16.8-78.2 28-120.6 33 43.4-26 76.6-67.2 92.4-116.2-40.6 24-85.6 41.6-133.4 51-38.4-40.8-93-66.2-153.4-66.2-116 0-210 94-210 210 0 16.4 1.8 32.4 5.4 47.8-174.6-8.8-329.4-92.4-433-219.6-18 31-28.4 67.2-28.4 105.6 0 72.8 37 137.2 93.4 174.8-34.4-1-66.8-10.6-95.2-26.2 0 0.8 0 1.8 0 2.6 0 101.8 72.4 186.8 168.6 206-17.6 4.8-36.2 7.4-55.4 7.4-13.6 0-26.6-1.4-39.6-3.8 26.8 83.4 104.4 144.2 196.2 146-72 56.4-162.4 90-261 90-17 0-33.6-1-50.2-3 93.2 59.8 203.6 94.4 322.2 94.4 386.4 0 597.8-320.2 597.8-597.8 0-9.2-0.2-18.2-0.6-27.2 41-29.4 76.6-66.4 104.8-108.6z"></path>
            </svg>
            <svg viewBox="0 0 877.7142857142857 1024" className="header-icon34">
      ...
      <style jsx>
        {`
          ...
          .header-thq-image-elm {
            width: 95px;
            height: 52px;
            object-fit: cover;
          }
          .header-thq-thq-burger-menu-elm-elm {
            display: none;
            z-index: 999;
            transition: 0.3s;
            align-items: center;
          ...
          .header-thq-thq-burger-menu-elm-elm:hover {
            animation: var(--dl-layout-space-twounits);
          }
          .header-icon10 {
            z-index: 3000;
          }
          ...
          .header-thq-thq-mobile-menu-elm-elm {
            top: 0px;
            flex: 0 0 auto;
            left: 0px;
            width: 100%;
          ...
          .header-thq-thq-heading-elm-elm {
            color: var(--dl-color-secondary-400);
            font-weight: 700;
            text-decoration: none;
          }
          .header-thq-thq-close-menu-elm-elm {
            display: flex;
            align-items: center;
            flex-direction: row;
            justify-content: space-between;
