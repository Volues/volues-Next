...
const Hero17 = (props) => {
  return (
    <>
      <div className={`hero17-thq-header78-elm ${props.rootClassName} `}>
        ...
        <div className="hero17-thq-content-elm2">
          <div className="hero17-thq-row-container-elm1 thq-mask-image-horizontal thq-animated-group-container-horizontal">
          ...
          <div className="hero17-thq-row-container-elm2 thq-mask-image-horizontal thq-animated-group-container-horizontal">
      ...
      <style jsx>
        {`
          ...
          .hero17-thq-text-elm1 {
            text-align: center;
          }
          .hero17-thq-text-elm2 {
            text-align: center;
          }
          .hero17-thq-actions-elm {
            gap: var(--dl-layout-space-unit);
            display: flex;
            align-items: flex-start;
            padding-top: var(--dl-layout-space-unit);
          }
          .hero17-thq-content-elm2 {
            gap: 24px;
            width: 100%;
            display: flex;
            position: relative;
          ...
          @media (max-width: 479px) {
            ...
            .hero17-thq-button-elm1 {
              width: 100%;
            }
            .hero17-thq-button-elm2 {
              width: 100%;
            }
            .hero17-text3 {
              font-family: Inter;
