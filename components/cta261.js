    ...
    <>
      <div className="thq-section-padding">
        <div className="thq-section-max-width">
          <div className="cta261-thq-accent2-bg-elm">
            <div className="cta261-thq-accent1-bg-elm">
              <div className="cta261-container2">
                <div className="cta261-thq-content-elm">
                ...
                <div className="cta261-thq-actions-elm">
                  <button
                    type="button"
      ...
      <style jsx>
        {`
          ...
          .cta261-thq-accent2-bg-elm:hover {
            transform: scale3d(1.1, 1.1, 1.1);
          }
          .cta261-thq-accent1-bg-elm {
            width: 100%;
            display: flex;
            transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg)
          ...
          .cta261-thq-content-elm {
            gap: 24px;
            display: flex;
            align-items: flex-start;
            flex-direction: column;
          }
          .cta261-thq-actions-elm {
            gap: 24px;
            flex: 1;
            display: flex;
            align-items: flex-start;
